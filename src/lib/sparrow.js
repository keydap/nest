...
export {AXIOS_SCIM_CREATE_CONFIG, SCIM_BASE_URL, USERS_URL, GROUPS_URL, APPS_URL, SCIM_JSON_TYPE, normalizeKeys, showWait, closeWait, showSuccess, showErr, confirm, loadGroupNamesAndIds, getGroupNamesAndIds}
...
function getGroupNamesAndIds() {
 ...
 function showErr(e, msg) {
     ...
     Notification.warning({message: msg, duration: 0})
 }
