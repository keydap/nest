...
public class UserDetailsPage extends BasePage {
    ScimResourceModel<User> srm = null;
    ...
    protected void onInitialize() {
        ...
        if(!id.isEmpty()) {
            ...
            srm = new ScimResourceModel<>(new User());
        }
        
        User user = srm.getObject(); // should be the model object NOT the original
        ...
        Form form = new Form("form"){
            ...
            protected void onSubmit() {
                if(!id.isEmpty()) { // PATCH
                    ...
                    Response<User> prResp = ConnectionUtil.get().addResource(user);
